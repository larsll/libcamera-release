## libcamera (jazzy) - 0.5.0-2

The packages in the `libcamera` repository were released into the `jazzy` distro by running `/home/deepracer/.local/bin/bloom-release libcamera --rosdistro jazzy --track jazzy --override-release-repository-url https://github.com/larsll/libcamera-release` on `Fri, 02 May 2025 13:52:14 -0000`
